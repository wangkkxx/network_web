...
CREATE TABLE `wshl_user`(
  ...
  `kf` VARCHAR(32) DEFAULT NULL,
  `money` DECIMAL(6,2) DEFAULT NULL,
  `purchased` VARCHAR(32) DEFAULT NULL,
  PRIMARY KEY  (`uid`)
);
INSERT INTO `wshl_user` VALUES('1', 'dingding', '123456', '丁丁', '456214197805129625', '1234215123', '15824124562', '1234215123@qq.com',"客服小明",0,NULL);
INSERT INTO `wshl_user` VALUES('2', 'dangdang', '123456', '当当', '340812198006132962', '12345612', '18612345678', '12345612@qq.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('3', 'tom', '123456', 'tom', '251612199903154852', '89802531', '18362451245', '89802531@qq.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('4', 'jerry', '123456', 'jerry', '142456196808283215', '9984512', '13815241236', '9984512@qq.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('5', 'david', '123456', 'david', '541245197312063416', '45123652', '15312456213', '45123652@qq.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('6', 'lilei', '123456', '李雷', '341246199610234928', '1452638479', '15612345689', '1452638479@qq.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('7', 'hanmeimei', '123456', '韩梅梅', '234512199511261349', '884615326', '17612354896', '884615326@qq.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('8', 'ada', '123456', 'ada', '340827199202184920', '554216389', '18612354869', 'ada@sina.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('9', 'lisa', '123456', 'lisa', '234513199707071285', '234214562', '15345821687', 'lisa@123.com',"客服小米",0,NULL);
INSERT INTO `wshl_user` VALUES('10', 'red', '123456', 'red', '451286187011264903', '34221689', '18362475162', '34221689@qq.com',"客服小米",0,NULL);
#客服信息表
CREATE TABLE `wshl_customerService`(
  `kid` INT(11)  NULL AUTO_INCREMENT,
  `kname` VARCHAR(32) DEFAULT NULL,
  `rname` VARCHAR(32) DEFAULT NULL,
  `kqq` INT(20) DEFAULT NULL,
  `kphone` VARCHAR(32) DEFAULT NULL,
  PRIMARY KEY  (`kid`)
);
INSERT INTO `wshl_customerService` VALUES(NULL,"客服小曦","林曦","613348860","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服小米","米蕊","613348861","0551-65603507-811");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服微微","钱微微","613348863","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服小宝","张宝林","613348864","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服笑笑","林笑","613348865","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服小沫","张沫","613348866","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服夏夏","夏云","613348867","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服芊芊","周芊芊","613348868","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服萌萌","何萌萌","613348869","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服小新","刘新","613348870","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服小瑾","杨瑾","613348871","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服倩倩","袁倩","613348872","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服小明","崔明宇","613348873","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服涵涵","刘涵","613348874","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服项贵良","项贵良","613348875","0551-65603507-801");
INSERT INTO `wshl_customerService` VALUES(NULL,"客服张强","张强","613348876","0551-65603507-801");
#订单-主机
CREATE TABLE `wshl_order_host`(
  `uid` INT(11)  NULL,                 #用户编号
  `uname` VARCHAR(32) DEFAULT NULL,    #用户名
  `hid` INT(11)  NULL AUTO_INCREMENT,  #产品编号
  `hname` VARCHAR(32) DEFAULT NULL,    #产品型号
  `room` VARCHAR(32) DEFAULT NULL,     #机房
  `dbs` VARCHAR(32) DEFAULT NULL,      #数据库容量
  `dbv` VARCHAR(32) DEFAULT NULL,      #数据库版本
  `ftp` VARCHAR(32) DEFAULT NULL,      #ftp用户名
  `flow` VARCHAR(32) DEFAULT NULL,     #流量
  `post` VARCHAR(32) DEFAULT NULL,     #邮局容量
  `duration` VARCHAR(32) DEFAULT NULL, #购买时长
  `space` VARCHAR(32) DEFAULT NULL,    #空间容量
  `price` VARCHAR(32) DEFAULT NULL,    #价格
  PRIMARY KEY  (`hid`)
);
INSERT INTO `wshl_order_host` VALUES('2','dangdang','1','香港1入门型','香港-232.247','100M','MySQL5.5[大小100M]','example1','2M','500M 10用户','1年','500M','98');
INSERT INTO `wshl_order_host` VALUES('5','david','2','香港1入门型','香港-232.247','100M','MySQL5.5[大小100M]','example1','2M','500M 10用户','1年','500M','98');
